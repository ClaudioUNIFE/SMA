{{-- resources/views/edit-thesis.blade.php --}}
<x-app-layout>
                ...
                <form action="{{ route('theses.update', $thesis->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                            ...
                            <div class="md:w-2/3">
                                <select name="id_museo" id="id_museo" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white" required>
                                    @foreach ($museums as $museum)
                                        <option value="{{ $museum->id }}" @if($thesis->id_museo == $museum->id) selected @endif>{{ $museum->nome_museo }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="md:w-2/3">
                                <select name="id_deposito" id="id_deposito" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white">
                                    @foreach ($deposits as $deposit)
                                        <option value="{{ $deposit->id }}" @if($thesis->id_deposito == $deposit->id) selected @endif>{{ $deposit->collocazione }}, {{ $deposit->deposito }}, stanza numero: {{ $deposit->codice_stanza }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="text" name="autore" id="autore" value="{{ $thesis->autore }}" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="text" name="titolo" id="titolo" value="{{ $thesis->titolo }}" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white" required>
                            </div>
                        </div>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="text" name="anno_accademico" id="anno_accademico" value="{{ $thesis->anno_accademico }}" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white" required>
                            </div>
                        </div>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="text" name="disciplina" id="disciplina" value="{{ $thesis->disciplina }}" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="text" name="relatore" id="relatore" value="{{ $thesis->relatore }}" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white" required>
                            </div>
                        </div>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="text" name="correlatore" id="correlatore" value="{{ $thesis->correlatore }}" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white">
                            </div>
                        </div>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="text" name="contro_relatore" id="contro_relatore" value="{{ $thesis->contro_relatore }}" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input type="url" name="percorso_file" id="percorso_file" value="{{ $thesis->percorso_file }}" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white" required>
                            </div>
                        </div>
                        ...
                        <div class="md:flex mb-6">
                            ...
                            <div class="md:w-2/3">
                                <textarea name="note" id="note" class="block w-full px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:bg-white">{{ $thesis->note }}</textarea>
                            </div>
                        </div>
                    </div>
