<x-app-layout>
    ...
    <div style="background-color: grey; padding: 30px; border-radius: 15px; margin:5%; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); max-width: 600px; margin-left: auto; margin-right: auto;">
      <h2 style="color: white; margin-bottom: 20px; text-align: center;">Create Deposit</h2>
      @if ($errors->any())
      ...
      @endif
      <form action="{{ route('deposits.store') }}" method="POST" style="display: flex; flex-direction: column; gap: 15px; align-items: center;">
          @csrf
